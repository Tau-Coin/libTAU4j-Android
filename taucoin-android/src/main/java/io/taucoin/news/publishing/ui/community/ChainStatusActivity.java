...
import io.taucoin.news.publishing.databinding.ActivityChainStatusBinding;
import io.taucoin.news.publishing.databinding.ReloadChainDialogBinding;
...
//        }
        ...
        if (null == mStatus || mStatus.balUpdateTime != status.balUpdateTime) {
            String balance = FmtMicrometer.fmtBalance(status.getInterimBalance());
