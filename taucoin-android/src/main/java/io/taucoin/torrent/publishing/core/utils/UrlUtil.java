...
public class UrlUtil {
    ...
    public static final String CHAIN_PATTERN = "tauchain:\\?(bs=[A-Fa-f0-9]{64}&)+(dn=[A-Fa-f0-9]{16}\\S{1,24})";
    public static final String AIRDROP_PATTERN = URL_SCHEME + "//[A-Fa-f0-9]{64}/airdrop/" + CHAIN_PATTERN;
