...
public interface BlockDao {
    ...
    String QUERY_CHAIN_STATUS = "SELECT a.syncingHeadBlock, a.headBlock, a.consensusBlock, a.difficulty, a.forkPoint," +
            " c.peerBlocks, c.totalRewards, d.totalPeers, d.totalCoin, e.balance, e.balUpdateTime" +
            " FROM Communities a" +
...
//            " AND (cc.tailBlock <= bb.blockNumber)" +
            ...
            " LEFT JOIN (SELECT chainID, publicKey, balance, balUpdateTime FROM Members WHERE chainID = :chainID" +
