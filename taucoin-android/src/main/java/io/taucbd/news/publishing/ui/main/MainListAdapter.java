...
import io.taucbd.news.publishing.databinding.ItemChatListBinding;
import io.taucbd.news.publishing.databinding.ItemGroupListBinding;
...
//                }
                ...
                int configChainLogo = Utils.getConfigChainLogo(bean.ID);
                ...
                if (isConfigChain) {
                    binding.ivGroup.setImageRes(configChainLogo);
                }
